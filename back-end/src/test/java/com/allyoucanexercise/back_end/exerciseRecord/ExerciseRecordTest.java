...
public class ExerciseRecordTest {
        ...
        void setUp() {
                ...
                cardioExerciseRecord = new ExerciseRecord(cardioExercise, user, earlierTime, workout, 1, workout,
                                0,
                                workout,
                                (float) 0, workout, (float) 0, workout, 120, workout, (float) 900, workout,
                                (float) 3.58,
                                workout);
                pushUpExerciseRecord = new ExerciseRecord(chestExercise, user, earlierTime, workout, 2, workout, 11,
                                workout,
                                (float) 15.00, workout, (float) 230, workout, 0, workout, (float) 0, workout, (float) 0,
                                workout);
        ...
        void testGetExerciseRecord() {
                ...
                ExerciseRecord exerciseRecord = exerciseRecordService.getExerciseRecord(user, chestExercise)
                                .orElse(null);
                ...
                assertThat(exerciseRecord.getMaxVolume()).isEqualTo((float) 230);
                assertThat(exerciseRecord.getMaxRepsWorkout()).isEqualTo(workout);
                assertThat(exerciseRecord.getMaxDistanceMeters()).isEqualTo((float) 0);
        ...
        void testGetExerciseRecordForCardio() {
                ...
                ExerciseRecord exerciseRecord = exerciseRecordService.getExerciseRecord(user, cardioExercise)
                                .orElse(null);
                assertThat(exerciseRecord.getMaxReps()).isEqualTo(0);
        ...
        @Test
        void testLowerPaceCreatesRecord() {

                SetSegmentDTO lowerPaceCardioSetSegmentDTO = setupSetSegmentDTO(null, null, 100, (float) 900,
                                DistanceMeasurement.METERS,
                                (float) 2.98);
                ExerciseSetDTO lowerPaceCardioSetDTO = setupExerciseSetDTO(
                                List.of(lowerPaceCardioSetSegmentDTO));

                WorkoutExerciseDetailsDTO lowerPaceCardioWorkoutExerciseDetailsDTO1 = setupWorkoutExerciseDetailsDTO(
                                (long) 1,
                                List.of(lowerPaceCardioSetDTO));

                Workout lowerPaceCardioWorkout = setupCompletedWorkout(user, "Cardio workout with lower pace per mile",
                                latestTime,
                                "Workout Notes");
                ...
                ExerciseRecord result = exerciseRecordService.saveExerciseRecord(lowerPaceCardioWorkout, cardioExercise,
                                lowerPaceCardioWorkoutExerciseDetailsDTO1, user);

                assertThat(result.getMaxSets()).isEqualTo(1);
                assertThat(result.getMaxReps()).isEqualTo(0);
                assertThat(result.getMaxDurationSeconds()).isEqualTo(120);
                assertThat(result.getMaxDistanceMeters()).isEqualTo((float) 900);
                assertThat(result.getMaxPacePerMile()).isEqualTo((float) 2.98);
                assertThat(result.getMaxPaceWorkout()).isEqualTo(lowerPaceCardioWorkout);
                assertThat(result.getMaxDurationWorkout()).isEqualTo(workout);
        ...
        @Test
        void HigherRepsInASegmentCreatesARecord() {

                SetSegmentDTO higherRepsSet1Segment1DTO = setupSetSegmentDTO(10, (float) 10, null, null, null, null);
                ExerciseSetDTO higherRepsSet1DTO = setupExerciseSetDTO(
                                List.of(higherRepsSet1Segment1DTO, set1Segment2DTO));

                WorkoutExerciseDetailsDTO higherRepsWorkoutExerciseDetailsDTO1 = setupWorkoutExerciseDetailsDTO(
                                (long) 1,
                                List.of(higherRepsSet1DTO, set2DTO));

                Workout higherRepsWorkout = setupCompletedWorkout(user, "Push up workout with Higher Reps", latestTime,
                                "Workout Notes");
                ...
                ExerciseRecord result = exerciseRecordService.saveExerciseRecord(higherRepsWorkout, chestExercise,
                                higherRepsWorkoutExerciseDetailsDTO1, user);

                assertThat(result.getMaxSets()).isEqualTo(2);
                assertThat(result.getLastExercised()).isEqualTo(latestTime);
                assertThat(result.getMaxReps()).isEqualTo(14);
                assertThat(result.getMaxRepsWorkout()).isEqualTo(higherRepsWorkout);
